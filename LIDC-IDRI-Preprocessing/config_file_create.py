...
if __name__ == "__main__":
    ...
    config['prepare_dataset'] = {
        ...
        'LIDC_DICOM_PATH': 'C:/Users/farah/Desktop/Temp/Lung Cancer Project/LIDC-IDRI-Preprocessing/LIDC-IDRI',
        # Directory to save the output files
        # Directory for masks
        'MASK_PATH':'C:/Users/farah/Desktop/Temp/Lung Cancer Project/LIDC-IDRI-Preprocessing/data/Mask',
        # Directory for images
        'IMAGE_PATH':'C:/Users/farah/Desktop/Temp/Lung Cancer Project/LIDC-IDRI-Preprocessing/data/Image',
        # To save images and mask that doesn't contain any nodule or cancer
        # These images will be used later to evaluate our model
        'CLEAN_PATH_IMAGE':'C:/Users/farah/Desktop/Temp/Lung Cancer Project/LIDC-IDRI-Preprocessing/data/Clean/Image',
        'CLEAN_PATH_MASK':'C:/Users/farah/Desktop/Temp/Lung Cancer Project/LIDC-IDRI-Preprocessing/data/Clean/Mask',
        # CSV file containing nodule information, malignancy, train test split
        'META_PATH': 'C:/Users/farah/Desktop/Temp/Lung Cancer Project/LIDC-IDRI-Preprocessing/data/Meta/',
